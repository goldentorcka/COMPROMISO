...
import CrudFormatos from "./format/crudFormat.jsx"; // Asegúrate de que la ruta y el nombre del archivo sean correctos
  ...
  return (
    <BrowserRouter>
      <Routes>
        ...
        <Route path="/Formatos" element={<CrudFormatos />} /> {/* Ruta para el componente de formatos */}
      </Routes>
    </BrowserRouter>
  );
}

...
//REGISTROPROCESOS
const RegisterProcess = React.lazy(() => import('./views/admin/procesos/RegisterProccess'))
...
const ProcedureList = React.lazy(() => import('./views/admin/lists/procedimientos/ProcedureList'))
//LISTA DE RESPONSABLES
const ResponsibleList = React.lazy(() => import('./views/admin/lists/responsables/ResponsibleList'))
...
const routes = [
  ...
  { path: '/register-proccess', name: 'Registrar Proceso', element: RegisterProcess, exact: true },
  // RUTAS DE LOS PROCEDIMIENTOS
  { path: '/register-procedure', name: 'Registrar Procedimiento', element: RegisterProcedure, exact: true },
  ...
  { path: 'register-unidad', name: 'Registrar Unidad', element: RegisterUnit, exact: true },
  
  //LISTAS DE LOS PROCESOS
  { path: '/list-processes', name: 'Lista de Procesos', element: ProcessList, exact: true },
  //LISTAS DE LOS PROCEDIMIENTOS
  { path: '/list-procedure', name: 'Lista de Procedimientos', element: ProcedureList, exact: true },
  //LISTAS DE LOS RESPONSABLES
  { path: '/list-responsible', name: 'Lista de Responses', element: ResponsibleList, exact: true },
  //LISTAS DE LAS AREAS

  //LISTAS DE LAS UNIDADES
